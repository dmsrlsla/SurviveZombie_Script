...
ASZProjectile::ASZProjectile()
{
	...
	CollisionComp->OnComponentHit.AddDynamic(this, &ASZProjectile::OnHit);		// set up a notification for when this component hits something blocking
...
// Called every frame
void ASZProjectile::Tick(float DeltaTime)
{
