...
struct FDeathMessage
{
	...
	TWeakObjectPtr<class USZDamageType> DamageType;
...
public:
	...
	// sent from SZWeapon, shows no ammo Text
	...
	//void SetMatchState(ESZMatchState::Type NewState);

	// Get state of current match
	//ESZMatchState::Type GetMatchState() const;
